...
| Anisotropic scale, rotation, partial regions, topology, weights, morphs | Unsupported | — | Requires new typed operations and allowed-change contracts. |
...
| Recipe | 2 | Version 1 remove recipes remain readable with unchanged meaning. |
| Build evidence | 3 | Earlier accepted evidence schemas remain under `schemas/v1`. |
